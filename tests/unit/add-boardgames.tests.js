...
suite('Add Boardgames page', function() {
  test('Page title', async function() {
    let res = await fetch("https://romanov871-exam.onrender.com/add-boardgame");
  ...
  test('Add valid boardgame', async function() {
    let res = await fetch(
      "https://romanov871-exam.onrender.com/add-boardgame",
      {
        method: 'POST',
        headers: {
  ...
  test('Add invalid boardgame', async function() {
    ...
    res = await fetch("https://romanov871-exam.onrender.com/");
    body = await res.text();
